...
public class TexturePaintView extends VisTable {
    ...
    public TexturePaintView()
    {
        ...
        preview.add(new VisLabel("Region Materials:", Style.label)).padRight(5);
        preview.add(textureTable).space(15);

        preview.add(new VisLabel("Brush Settings", Style.label)).padRight(10);
        preview.add(brush);
        preview.add(blendImage = new Image(Backgrounds.create(Color.DARK_GRAY, TerrainBlendMap.WIDTH, TerrainBlendMap.HEIGHT))).size(128, 128);
        preview.row();
        blendImage.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                ...
                TerrainBlendMap blendMap = Editor.getCurrentCell().getTerrain().getTerrainBlendMap();
                dialog.add(new Image(Backgrounds.create(blendMap.getMap(), TerrainBlendMap.WIDTH, TerrainBlendMap.HEIGHT)));
                dialog.pack();
        ...
        i.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (button == 2) {
                    ...
                    final VisDialog dialog = new VisDialog("Material EditorBrushTool");
                    Editor.ui.getEditorMaterials().updateMaterialList();
                    Editor.ui.getEditorMaterials().setCallback(new MaterialSelectCallback() {
                        @Override
                        void materialSelected(Material asset) {
                    ...
                    dialog.addCloseButton();
                    dialog.add(Editor.ui.getEditorMaterials());
