...
public class ColorPicker extends Table {
    ...
    public ColorPicker() {
        ...
        // color selected
//		imgColor = new Image(new TextureRegionDrawable(TextureManager.get("assets/pixel.png")));
        ...
        Table tableTextFields = new Table();

        tfHue = new TextField("", Style.textField);
        ...
        tfSaturation = new TextField("", Style.textField);
        ...
        tfLuminance = new TextField("", Style.textField);
        ...
        tfRed = new TextField("", Style.textField);
        ...
        tfGreen = new TextField("", Style.textField);
        ...
        tfBlue = new TextField("", Style.textField);
        ...
        tableTextFields.row();
        tableTextFields.add(new Label("hue", Style.label)).right();
        tableTextFields.add(tfHue).left().width(50).spaceRight(20);
        tableTextFields.add(new Label("red", Style.label)).right();
        tableTextFields.add(tfRed).left().width(50);

        tableTextFields.row();
        tableTextFields.add(new Label("saturation", Style.label)).right();
        tableTextFields.add(tfSaturation).left().width(50);
        tableTextFields.add(new Label("green", Style.label)).right();
        tableTextFields.add(tfGreen).left().width(50);

        tableTextFields.row();
        tableTextFields.add(new Label("luminance", Style.label)).right();
        tableTextFields.add(tfLuminance).left().width(50);
        tableTextFields.add(new Label("blue", Style.label)).right();
