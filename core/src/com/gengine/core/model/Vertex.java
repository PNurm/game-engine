...
public class Vertex {
    ...
    public final float[] materialWeights = new float[MULTITEXTURE_COUNT];
    ...
    public Vertex set(final MeshPartBuilder.VertexInfo other) {
    ...
    public Vertex setPos(Vector3 pos) {
        if ((hasPosition = pos != null) == true) position.set(pos);
        return this;
    }
    ...
    public Vertex setUV(Vector2 uv) {
        if ((hasUV = uv != null) == true) this.uv.set(uv);
        return this;
    }
